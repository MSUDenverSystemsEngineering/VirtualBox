...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'iexplore,virtualbox' -CheckDiskSpace -PersistPrompt
		...
		$exitCode = Execute-Process -Path "$dirFiles\VirtualBox-6.1.10-138449-Win.exe" -Parameters "--msiparams INSTALLDIR=C:\VirtualBox --silent" -WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'iexplore,virtualbox' -CloseAppsCountdown 60
		...
		Execute-MSI -Action "Uninstall" -Path "{0359AF05-E674-4ED4-B9FB-B77918617667}"
