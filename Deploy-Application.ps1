...
Try {
	...
	[string]$appName = 'VirtualBox'
	[string]$appVersion = '7.0.8'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'virtualbox' -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
		$applicationList = 'virtualbox'
		...
		$exitCode = Execute-Process -Path "$dirFiles\VirtualBox-7.0.8-156879-Win.exe" -Parameters "--msiparams INSTALLDIR=C:\VirtualBox --silent" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		...
		Copy-Item -Path "$dirFiles\Oracle VMs\" -Destination "$envSystemDrive\Oracle VMs" -Recurse
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'virtualbox' -CloseAppsCountdown 60
		...
		Write-Log -Message "Attempting to run VirtualBox uninstaller..." -Source 'Installation' -LogType 'CMTrace'
		$exitCode = Execute-MSI -Action Uninstall -Path "{2D9D28CD-84DE-4DC7-BAD2-CA5505324049}" -Parameters '/qn' -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		...
		Remove-Folder -Path "$envSystemDrive\Oracle VMs"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB7AF8/ZsodgLUW
# wcHGIhRee5hTZhpomAyIX0C7oL/6NKCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDpjIsuCjIhV9zp
# i86D/TkLxeGGaspzIxWxFKVx8amTCDANBgkqhkiG9w0BAQEFAASCAYBAtJA4kJP3
# KbvGlEn0wEAX4/9FyL/r/mYAIHol3uC8hdhunYewyB/p39HntuyDO5jelzN2lvUE
# q8Hyi+Y0jCnzYtggxTckyucr9m8kXKMWOCNst5AxgxGmjXY3o3ZTuDn4luzcaV9+
# i6ze6X7n9LejRE22a02KLLTZYFgtBd7+xodvCUKH3MF5Y03YjZzhUK4swN/tuUiJ
# txpekhEe/0sd5gyiLlNxI5IU23neRONyDJWwYYg1WonbZlv2NMD55cObWXaWBRbv
# 6zXIALFgbsqW7U7QFD/q8fqCYmoxA8FX/l6+9MwA18+4s12HxiHw6eqTtLthGhMl
# XgNGjFYsyMNnigdwwCv0TErvMxFR1vP7afCxJ0sdi6GFBki+AK9zK5zDhcm+vxfh
# lZtiG8caTRw5pGPR1/llekZ28d0ngvE9quQ4m8nvafRGU8H/dWuLOkNNUwr6FGNh
# 9EQebE5NPPMr2Hm5gCOvDNKA3nL1Sb5fAJ4iAynNofeKW+vxL0H6FrOhggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNjE1MTUz
# NDIyWjA/BgkqhkiG9w0BCQQxMgQwSwryxqT2dP/pxLA3gShmu1n46mJXc+9exZXR
# OLU/od1JGbO9TxuvzW2dKGnlGGQTMA0GCSqGSIb3DQEBAQUABIICAD6MOvfx4jri
# jpTtHZas8zSYnQqESs09sXt3ZhL8JYdyOeMoCvG5NcyJnzwPdSgzAWtN3zI0WgUB
# fLeWd6pbP4nmWP9LjUWyakK9AWjOf0jVhL4p+dwbgaFQySQLWDHrpUKMsT52MerU
# kI+yNMkoxo3jpA0hLMdOCBE8Xft28ieN9joF+hTfwiPEd4xMgPkSllzmxFuI6eFh
# TIoikj7RpPpHQ9ZGSnSyFZ7rC4KPDZ9tx7PAHv3yLDrKjACfPEsTza+m9e/XhqKX
# UEameV6dlj+qFqaJnYZg8crAedTC9HcwiMMwAQO3Hp/Q7eSzaHa8q887VOKZFTCT
# LC//73bSnBi7Vlal8cHeR357NOWvOetU0LZYsskd2cHZfTfAadiIPVloGALGep7y
# Z1qgEVEiCFdPdRZnQhomcVALmIGFF1nHtfiesc+jZZ7+58ZxjC6k6Hu6tEgJpd/g
# XUOJ6n0EIwXuv3hv6CDl5s9banP1ZnB+ewDQaQl/C7ZVPAmV9MxQsA1jIrNLzn4c
# 263IIzx/iXB6YmHFFpoNgpGBlrFBe0TW+48yTBu6MRFvJDN/TkcO2P6ADJwbdNtz
# bOw9a49J/CZlzew6PUkPq4esNCPZARTx2b+GYvrEKEz26yfm/Va04Zd+qqAnkkvG
# ZKQZCFADl5FYUbA9HE0/ktEmkA4Cnm1X
